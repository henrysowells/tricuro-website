...
export function GlobalPerspectives() {
  return (
    <section id="global" className="relative overflow-hidden bg-white border-t border-black/[0.08] py-16 px-8 md:px-16">
      ...
      />
      <div className="relative z-10 max-w-[1100px] mx-auto grid md:grid-cols-[340px_1fr] gap-16 md:gap-28 items-start">
